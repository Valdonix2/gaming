...
local entityTable = Spawner.createEntity({
    ...
    Model = "https://github.com/Valdonix2/gaming/raw/main/smile.rbxm", -- Can be GitHub file or rbxassetid
    ...
    CustomDialog = {"You got killed by Smile", "Its like Ambush but harder.", "It rebounds 3 - 8 times at 2 second interval!"}, -- Custom death message
})
